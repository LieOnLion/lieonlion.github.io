			...
			<div className="flex flex-row max-sm:flex-col max-sm:gap-4 justify-between items-center w-full">
				<div className="flex items-center gap-5">
					<svg className="w-8 h-8">
						<use
							href="/assets/v1/logo/svg/lieonstudios.svg#studio-logo"
							className="fill-colour-primary-500 scale-32"
						></use>
					</svg>
				...
				<div className="flex gap-4">
					<a href="https://discord.gg/sA42pp6cuX">
						<svg className="w-6 h-6">
							<use href="/assets/v1/social/svg/round-solid.svg#discord"></use>
						</svg>
					</a>
					<a href="https://youtube.com/@lieonlion?sub_confirmation=1">
						<svg className="w-6 h-6">
							<use href="/assets/v1/social/svg/round-solid.svg#youtube"></use>
						</svg>
					</a>
					<a href="https://tiktok.com/@slushieposts">
						<svg className="w-6 h-6">
							<use href="/assets/v1/social/svg/round-solid.svg#tiktok"></use>
						</svg>
					</a>
					<a href="https://modrinth.com/user/lieonlion">
						<svg className="w-6 h-6">
							<use href="/assets/v1/social/svg/round-solid.svg#modrinth"></use>
						</svg>
					</a>
					<a href="https://curseforge.com/members/lieonlion/">
						<svg className="w-6 h-6">
							<use href="/assets/v1/social/svg/round-solid.svg#curseforge"></use>
						</svg>
					</a>
				</div>
			</div>
